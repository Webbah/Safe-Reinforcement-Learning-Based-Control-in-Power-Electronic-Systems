...
if save_results:
    fig.savefig(f'{folder_name}/all_rewards_MA_1000_Rconst2.pgf')
    fig.savefig(f'{folder_name}/all_rewards_MA_1000_Rconst2.png')
    fig.savefig(f'{folder_name}/all_rewards_MA_1000_Rconst2.pdf')

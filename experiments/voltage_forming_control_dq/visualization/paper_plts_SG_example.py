...
for tr in range(len(trial)):
    ...
    if episode_list is not None:
        for episode, terminated in zip(episode_list, terminated_list):
            ...
            if save_results:
                fig.savefig(f'{folder_name}/' + study_name + 'timeseries.pgf')
                fig.savefig(f'{folder_name}/' + study_name + 'timeseries.png')
                fig.savefig(f'{folder_name}/' + study_name + 'timeseries.pdf')
            ...
            if RLS:
                ...
                axs[0, 0].legend(bbox_to_anchor=(0.75, 1.02, 1, 0.2), loc="lower left", mode="expand", borderaxespad=0,
                              ncol=4)

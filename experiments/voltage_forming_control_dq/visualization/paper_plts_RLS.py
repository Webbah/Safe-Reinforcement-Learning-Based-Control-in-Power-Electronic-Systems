...
for tr in range(len(trial)):
    ...
    if episode_list is not None:
        for episode, terminated in zip(episode_list, terminated_list):
            ...
            if save_results:
                fig.savefig(f'{folder_name}/' + save_name + 'timeseries_testcase.pgf')
                fig.savefig(f'{folder_name}/' + save_name + 'timeseries_testcase.png')
                fig.savefig(f'{folder_name}/' + save_name + 'timeseries_testcase.pdf')
